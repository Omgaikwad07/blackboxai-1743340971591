...
public class ProductDetailsFragment extends Fragment {
    private TextInputEditText nameEditText, barcodeEditText, expiryDateEditText, quantityEditText;
    ...
    private void initializeViews(View view) {
        ...
        barcodeEditText = view.findViewById(R.id.barcode);
    ...
    private void loadBarcodeFromArguments() {
    ...
    private void saveProduct() {
        ...
        if (validateInputs(name, barcode, expiryDate, quantityStr, category)) {
            int quantity = Integer.parseInt(quantityStr);
            Product product = new Product(name, expiryDate, category, quantity, barcode);
    ...
    private boolean validateInputs(String name, String barcode, 
                                 String expiryDate, String quantity, String category) {
        if (name.isEmpty()) {
            nameEditText.setError(getString(R.string.name_required));
            return false;
        }
        if (barcode.isEmpty()) {
            barcodeEditText.setError(getString(R.string.barcode_required));
            return false;
        }
